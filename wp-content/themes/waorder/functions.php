 ...
 */
 ...
 define( 'WAORDER_SERVER', 'https://saungdigital.com/' );
...
function waorder_lislis(){
    ...
    $transient = get_transient('waorderlislis');
        ...
        $result = waorder_license('nullmasterinbabiatoorg', 'nullmaster@babiato.org');
